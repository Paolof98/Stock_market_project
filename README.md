...
The findings of the regression models are summarised in the following table. The numbers represent the coefficient estimates of the OLS models:
...
* **All stock market sectors but Bitcoin are procyclical:** as the GDP growth increases, so do stock market prices, with some sectors growing more than others: when the economy is thriving, people are more confident on consumer discretionary, tech and healthcare stocks, and they are not as confident on investing in financials and utilities stocks.
